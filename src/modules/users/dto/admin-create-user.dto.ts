 ...
 * Endpoint ini hanya boleh diakses actor dengan Action.Create (lihat
 * UsersController) — otorisasi dicek di controller lewat PoliciesGuard,
 * BUKAN di sini (DTO cuma validasi bentuk data).
 */
